...
public partial class Manage_list : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        this.gvNewsList.DataSource = db.GetDataSet("select * from tb_News where style='" + this.ddlNewsStyle.SelectedValue.Trim() + "' order by id", "tbNews");
    ...
    protected void searchBind()
    {
        ...
        gvNewsList.DataSource = db.GetDataSet(strSql, "tbNews");
    ...
    protected void gvNewsList_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        db.ExecSql("delete  from tb_News where id='" + this.gvNewsList.DataKeys[e.RowIndex].Value.ToString() + "'");
        if (IntSearch == 1)
        {
            this.searchBind();
        }
